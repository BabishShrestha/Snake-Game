...
class snake
{
	...
	void Menu()
	{
		SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE), 11); cout << (char)1; //for green color
     	CPos(7,5); cout <<" Welcome to the ' S N A K E - - - G A M E '";
     	CPos(12,5); cout<<" How To Control:";
     	CPos(14,5); cout<<" Press 'a' for 'Left','d' for 'Right','w' for 'Up' and 's' for 'Down'"; 
     	CPos(17,5); cout << " Creating players:";
     	CPos(19,5); cout << " Enter Player's name: "; cin >> oname;
	...
	{	
     	...
     	cPos.Y = 3;
     	SetConsoleCursorPosition(GetStdHandle(STD_OUTPUT_HANDLE), cPos); 
		CPos(4,20); cout<<"' S N A K E - - - - - - - - G A M E '";
		for(m=0;m<5;m++)
		{
			cout<<endl;
		}
...
int main()
{
	snake s1;
	int n=0,sc=0,l;
	PlaySound(TEXT("C:\\Users\\vishal\\Desktop\\Nightcore - River Flows In You.wav"),NULL,SND_ASYNC);
